...
object JSON_Generic_Solution {
  ...
  def main(args: Array[String]): Unit = {
   ...
   val inputFile = "F:\\VMWareWin10\\Module-5\\Spark\\JSONGenericSolution\\products.json"
  // val inputFile = "C:\\products.json"
   //  val outputPath = args(1)
    val outputPath = "F:\\VMWareWin10\\Module-5\\Spark\\JSONGenericSolution\\output.txt"
    ...
    try {
      ...
      val prop_file = "F:\\VMWareWin10\\Module-5\\Spark\\JSONGenericSolution\\fields.txt"
      prop.load(new FileInputStream(prop_file))

      val jsonColumnsList = prop.getProperty("product_fields")
